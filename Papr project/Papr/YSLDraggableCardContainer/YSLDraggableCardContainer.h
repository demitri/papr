...
@property (nonatomic, weak) IBOutlet id <YSLDraggableCardContainerDataSource> dataSource;
@property (nonatomic, weak) IBOutlet id <YSLDraggableCardContainerDelegate> delegate;
